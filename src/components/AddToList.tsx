...
const AddToList: React.FC<IProps> = ({ people, setPeople }) => {
    ...
    return (
        <div className="AddToList">
            ...
            <input type="text" placeholder="Image Url" name="img" className="AddToList-input" value={input.img} onChange={handleChange} />
            <textarea placeholder="Notes" name="note" className="AddToList-input" value={input.note} onChange={handleChange} />
